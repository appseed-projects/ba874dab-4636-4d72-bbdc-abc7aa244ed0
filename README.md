...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-17 16:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ba874dab-4636-4d72-bbdc-abc7aa244ed0.git
$ cd ba874dab-4636-4d72-bbdc-abc7aa244ed0
```
